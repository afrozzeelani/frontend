      ...
      <div className="d-flex flex-column justify-between">
        <div className="d-flex justify-content-between aline-items-center">
          <h4 className="fw-bold  my-auto text-muted">
            Approved Leaves <span className="text-danger">({approvedLeaves})</span>
          </h4>
              ...
              {filteredData
                ...
                .map((data, index) => (
                  <tr className="fw-bold" key={index}>
                    ...
                    <td style={{ verticalAlign: 'middle' }} className="py-1  "><span className="bg-danger text-white px-2 py-1 rounded-5">{data.Status}</span></td>
