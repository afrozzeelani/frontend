      ...
      <div className="d-flex flex-column justify-between">
        <div className="d-flex justify-content-between aline-items-center">
          <h4 className="fw-bold my-auto text-muted">
            Approved Leaves <span className="text-primary">({approvedLeaves})</span>
          </h4>
                    ...
                    <td className="py-1">
                      <div className="d-flex aline-center gap-2">
                        <div style={{ height: '40px', width: '40px' }}><img style={{ height: '100%', width: '100%', borderRadius: '50%', overflow: 'hidden', objectFit: 'cover' }} src={
                          ...
                          <span style={{ fontSize: '12px' }} className="fw-bold">{data.empID}</span>
                          <span style={{ fontSize: '15px' }} className="fw-bold text-capitalize text-primary">{data.Name}</span></div>
                      </div>
                    </td>
                    <td style={{ verticalAlign: 'middle' }} className="py-1 text-muted">{data.Leavetype}</td>
                    <td style={{ verticalAlign: 'middle' }} className="py-1 text-muted">{data.FromDate}</td>
                    <td style={{ verticalAlign: 'middle' }} className="py-1 text-muted">{data.ToDate}</td>
                    <td style={{ verticalAlign: 'middle' }} className="py-1  "><span className="bg-success text-white px-2 py-1 rounded-5">{data.Status}</span></td>
                    <td style={{ verticalAlign: 'middle' }} className="py-1 text-muted">{data.Reasonforleave}</td>
                    <td style={{ verticalAlign: 'middle' }} className="py-1 text-muted">
                      <div
