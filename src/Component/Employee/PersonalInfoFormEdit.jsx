...
const PersonalInfoFormEdit = (props) => {
  ...
  return (
    <div className="container-fluid position-relative" >
      <div style={{ marginTop: '-.5rem', minHeight: '95vh' }} className="row bg-light p-2">
        <div className="col-md-4 col-0"><img src={personalinfoimage} alt="" /></div>
        <div className="col-md-8 col-0 ">
          <div className="">
            ...
            >
              <h4 style={{ position: "sticky", top: '0', zIndex: '2' }} className="fw-bold text-muted py-3 w-100 bg-light ">
                Edit Employee info
              </h4>
              <Form.Group className="col-12 col-md-6 d-flex flex-column gap-1" as={Row}>
              ...
              <div className="d-flex m-0 gap-3 py-2">
                ...
                <button className="btn btn-danger px-5" type="reset" onClick={props.onFormEditClose}>
                  cancel
                </button>
              </div>
            </Form>
