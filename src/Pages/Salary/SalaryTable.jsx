...
const AdminSalaryTable = (props) => {
  ...
  return (
    <div className="container-fluid">
      ...
      {!loading ? (
        <div>
          <div className="pr-5 pr-sm-0" style={{ height: '70vh', overflow: 'auto', width: '100%' }}>
          ...
          <div style={{ position: 'stickey', bottom: '1%' }} className="container-fluid bg-light p-2 d-flex justify-content-between">
