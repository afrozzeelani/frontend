      ...
      <div className="birthday shadow position-relative">
        ...
        <div>
          {upcomingBirthdays.length > 0 ? (
            ...
            <div className="d-flex flex-column justify-content-center aline-items-center gap-3" style={{ height: '100%', width: '100%' }}><img style={{ height: '60%', width: '60%' }} className="mx-auto" src={HappyBirthday} alt="Happy Birthday" />
              <p style={{ opacity: '60%', fontSize: '13px' }} className="text-center w-75 mx-auto  fw-bold text-muted ">No upcoming birthdays in the next 7 days.</p></div>
          )}
        </div>
      </div>
    </div>
